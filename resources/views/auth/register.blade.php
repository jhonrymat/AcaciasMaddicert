    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="nombre_2" class="block mt-1 w-full" type="text" name="nombre_2" :value="old('nombre_2')" required autofocus autocomplete="nombre_2" />
            </div>
            {{-- apellido_1 --}}
            <div>
                <x-label for="apellido_1" value="{{ __('Apellido_1') }}" />
                <x-input id="apellido_1" class="block mt-1 w-full" type="text" name="apellido_1" :value="old('apellido_1')" required autofocus autocomplete="apellido_1" />
            </div>
            {{-- apellido_2 --}}
            <div>
                <x-label for="apellido_2" value="{{ __('Apellido_2') }}" />
                <x-input id="apellido_2" class="block mt-1 w-full" type="text" name="apellido_2" :value="old('apellido_2')" required autofocus autocomplete="apellido_2" />
            </div>
            ...
            <div>
                ...
                <x-input id="telefonoContacto" class="block mt-1 w-full" type="text" name="telefonoContacto" :value="old('telefonoContacto')" required autofocus autocomplete="telefonoContacto" />
            </div>
            {{-- fechaNacimiento --}}
            <div>
            ...
            <div>
                ...
                <x-input id="numeroIdentificacion" class="block mt-1 w-full" type="text" name="numeroIdentificacion" :value="old('numeroIdentificacion')" required autofocus autocomplete="numeroIdentificacion" />
            </div>
            {{-- ciudadExpedicion --}}
            <div>
                <x-label for="ciudadExpedicion" value="{{ __('Ciudad de Expedicion') }}" />
                <x-input id="ciudadExpedicion" class="block mt-1 w-full" type="text" name="ciudadExpedicion" :value="old('ciudadExpedicion')" required autofocus autocomplete="ciudadExpedicion" />
            </div>
